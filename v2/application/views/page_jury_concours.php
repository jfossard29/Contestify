                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        // Affichage d’une ligne de tableau pour un pseudo non encore traité
                            ...
                            echo "<td>";
                            if ($co["phase_concours"]=="Inscription") {
                                echo "<a class='btn btn-success btn-block btn-round' href='".base_url()."index.php/jury/affichercandidature/".$co["ccr_id"]."'>Inscription</a>";
                            }
                            if ($co["phase_concours"]=="selection" ||$co["phase_concours"]=="finale" || $co["phase_concours"]=="terminée") {
                                echo "<a class='btn btn-warning btn-block btn-round' href='".base_url()."index.php/jury/affichercandidature/".$co["ccr_id"]."'>Galerie</a>";
                            }
